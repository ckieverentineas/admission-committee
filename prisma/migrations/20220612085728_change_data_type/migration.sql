/*
  ...
  - You are about to alter the column `birthday` on the `Passport` table. The data in that column could be lost. The data in that column will be cast from `Int` to `DateTime`.
